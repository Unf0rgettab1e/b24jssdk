...
The tool uses [@bitrix24/b24jssdk](https://www.npmjs.com/package/@bitrix24/b24jssdk) for API communication and [citty](https://github.com/unjs/citty) for command-line interface.
...
- **Bitrix24 webhook** with the following permissions:
  ...
  - `crm.contact.add` — for creating contacts
  - `crm.company.add` — for creating companies
...
```bash
B24_HOOK=https://your-domain.bitrix24.com/rest/user-id/webhook-code/
```
...
- **Title**: Realistic task names in 4 languages (English, Russian, Spanish, Chinese) using verb + object patterns (e.g., "Prepare quarterly report", "Протестировать API-эндпоинты")
...
- **Name**: Realistic first and last names in 4 languages (English, Russian, Spanish, Chinese)
- **Email**: Generated from name (e.g., `john.smith@gmail.com`, `王伟@outlook.com`)
- **Phone**: Country-specific format (+1 for US, +7 for Russia, +34 for Spain, +86 for China)
...
- [@bitrix24/b24jssdk Package](https://www.npmjs.com/package/@bitrix24/b24jssdk)
- [Main SDK Documentation](https://bitrix24.github.io/b24jssdk/)
